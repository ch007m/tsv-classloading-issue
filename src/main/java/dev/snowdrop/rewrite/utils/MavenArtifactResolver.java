...
public class MavenArtifactResolver implements Closeable {
     ...
     */
    public static List<Dependency> convertModelDependencyToAetherDependency(List<org.apache.maven.model.Dependency> modelDependencies) {
        return modelDependencies.stream()
                .map(dep -> {
                    ...
                    try {
                        ...
                        aetherArtifact = new DefaultArtifact(coords);
                    } catch (IllegalArgumentException e) {
                    ...
                    return new Dependency(aetherArtifact, scope, optional);
                })
